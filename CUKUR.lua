...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\na𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻 𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉"
exit 1
fi
if [ ! $token ]; then
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻 𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉ ┉"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/CUKURLTEAM/Files_CUKUR/main/File_Bot/commands.lua") 
...
function Devcukur(msg) 
local hash = database:sismember(bot_id.."Dev:cukur:2", msg.sender_user_id_) 
...
if hash or SudoBot(msg) or Devcukur(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or Devcukur(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or Devcukur(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or Devcukur(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or Devcukur(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or Devcukur(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or Devcukur(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif database:sismember(bot_id.."Dev:cukur:2", user_id) then
var = true  
...
local UserName = (data.username_ or "CUKUR_SO")
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇ÇUKUR.")  
...
if not Devcukur(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if Devcukur(msg) and msg.reply_to_message_id_ ~= 0  then    
...
if text == 'تفعيل التواصل ☆' and Devcukur(msg) then  
...
if text == 'تعطيل التواصل ☆' and Devcukur(msg) then  
...
if text == 'تفعيل البوت الخدمي ☆' and Devcukur(msg) then  
...
if text == 'تعطيل البوت الخدمي ☆' and Devcukur(msg) then  
...
if text == 'ضع كليشه ستارت ☆' and Devcukur(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,'☆︙ ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ☆' and Devcukur(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,'☆︙ تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ☆' and Devcukur(msg) then 
...
os.execute('wget https://raw.githubusercontent.com/CUKURLTEAM/CUKUR/main/CUKUR.lua')
send(msg.chat_id_, msg.id_,'☆︙ تم تحديث السورس\n☆︙ لديك اخر اصدار لسورس الحفره\n☆︙ الاصدار » { v 1.6 }')
dofile('CUKUR.lua')  
end
if text == 'الاصدار ☆' and Devcukur(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'☆︙ اصدار  الحفره \n☆︙ الاصدار »{ v 1.6 }')
end
if text == "ضع اسم للبوت ☆" and Devcukur(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ☆' and Devcukur(msg) then 
...
if text == 'المشتركين ☆' and Devcukur(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n☆︙ المشتركين»{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ☆' and Devcukur(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n☆︙ الكروبات»{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ☆") and Devcukur(msg) then
...
if text == ("الثانويين ☆") and Devcukur(msg) then
local list = database:smembers(bot_id..'Dev:cukur:2')
t = "\n☆︙ قائمة الثانويين \n𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
-------------
if text == "حصريات و تحديثات الحفره" and Devcukur(msg) then
local updatech =[[
*يجب عليك الاشتراك في قناة*
*تحديثات وشروحات  الحفره*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇ÇUKUR.', url="t.me/CUKUR_SO"}},
}
...
-----------
if text == ("قائمه العام ☆") and Devcukur(msg) then
...
if text == ("قائمه الكتم العام ☆") and Devcukur(msg) then
...
if text=="اذاعه خاص ☆" and msg.reply_to_message_id_ == 0 and Devcukur(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل الان اذاعتك؟ \n☆︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ☆" and msg.reply_to_message_id_ == 0 and Devcukur(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل الان اذاعتك؟ \n☆︙ للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ☆" and msg.reply_to_message_id_ == 0 and Devcukur(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل الان اذاعتك؟ \n☆︙ للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ☆" and msg.reply_to_message_id_ == 0  and Devcukur(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_,"☆︙ ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ☆" and msg.reply_to_message_id_ == 0  and Devcukur(msg) then 
...
if text == "تنظيف الكروبات ☆" and Devcukur(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مطور @(.*)$") and Devcukur(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and Devcukur(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and Devcukur(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and Devcukur(msg) then
...
if CUKUR1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'☆︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CUKUR_SO')..') \n☆︙ '..CUKUR1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"☆︙ العضو : {["..data.first_name_.."](T.ME/CUKUR_SO)}\n☆︙ ["..CUKUR_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "☆︙ عذرا » {["..data.first_name_.."](T.ME/CUKUR_SO)}\n☆︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not Devcukur(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and Devcukur(msg) then
...
if text and text:match("^تغير الاشتراك$") and Devcukur(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☆︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and Devcukur(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☆︙ حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ☆" and Devcukur(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "☆︙ تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ☆$") and Devcukur(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '☆︙ حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ☆" and Devcukur(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ☆" and Devcukur(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "☆︙ تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ☆" and Devcukur(msg) then  
...
if t2.id_ then 
name_MRcukur = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRcukur then 
names_MRcukur = database:smembers(bot_id.."CUKUR:blocname"..msg.chat_id_) or ""
if names_MRcukur and names_MRcukur[1] then 
for i=1,#names_MRcukur do 
if name_MRcukur:match("(.*)("..names_MRcukur[i]..")(.*)") then 
...
function cukur_mrcukur_new(mrcukur1,mrcukur2)
if mrcukur2 and mrcukur2.first_name_ then 
if mrcukur2.first_name_:match("(.*)"..database:get(bot_id.."CUKUR:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."CUKUR:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrcukur_nnn = database:get(bot_id.."CUKUR:nump"..msg.chat_id_) or 5
local mrcukur_nnn2 = database:get(bot_id.."CUKUR:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrcukur_nnn2) == tonumber(mrcukur_nnn) or tonumber(mrcukur_nnn2) > tonumber(mrcukur_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."CUKUR:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "☆︙ عزيزي >>["..mrcukur2.username_.."](https://t.me/"..(mrcukur2.username_ or "CUKUR_SO")..")\n☆︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."CUKUR:teh"..msg.chat_id_).."} بجانب اسمك\n☆︙ عدد المحاولات المتبقيه {"..(tonumber(mrcukur_nnn) - tonumber(mrcukur_nnn2)).."}")
end
end
end
end
bnnaGet(id, cukur_mrcukur_new)
end
end
...
☆ ↬⦑ SOURCE CUKUR ⦒ 
==================
☆ ↬︙ [Source Channel](http://t.me/CUKUR_SO)
==================
...
if text == 'رفع نسخه الاحتياطيه' and Devcukur(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'☆︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'CUKUR_SO')..') \n☆︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'☆︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'CUKUR_SO')..') \n☆︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and Devcukur(msg) then    
dofile('CUKUR.lua')  
send(msg.chat_id_, msg.id_, '☆︙ تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and Devcukur(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and Devcukur(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and Devcukur(msg) then
...
if text and text:match("^حظر عام (%d+)$") and Devcukur(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and Devcukur(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and Devcukur(msg) then
...
if text and text:match("^كتم عام (%d+)$") and Devcukur(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and Devcukur(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and Devcukur(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and Devcukur(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and Devcukur(msg) then
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = dataa.member_count_},function(ta,cukur)
x = 0
tags = 0
...
if Devcukur(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/CUKURLTEAM/Files_CUKUR/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ☆∫ اهلا بك في متجر ملفات الحفره\n ☆∫ ملفات السورس ↓\n𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n\n"
local TextE = "\n𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n ☆∫ علامة تعني { ✓ } ملف مفعل\n ☆∫ علامة تعني { ✘ } ملف معطل\n ☆∫ قناة  الحفره ↓\n".." ☆∫ [اضغط هنا لدخول](t.me/CUKUR_SO) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/CUKURLTEAM/Files_CUKUR/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('CUKUR.lua')  
else
send(msg.chat_id_, msg.id_," ☆∫ عذرا الملف لايدعم  الحفره \n") 
end
return false
end
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and Devcukur(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and Devcukur(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if database:get(bot_id..'DRAGOON:change:cukur'..msg.chat_id_) then
Text = 'تم تفعيل تحويل الصيغ'
database:del(bot_id..'DRAGOON:change:cukur'..msg.chat_id_)  
else
...
if not database:get(bot_id..'DRAGOON:change:cukur'..msg.chat_id_) then
database:set(bot_id..'DRAGOON:change:cukur'..msg.chat_id_,true)  
Text = '\n☆︙ تم تعطيل امر تحويل'
else
...
if text == 'تحويل' and not database:get(bot_id..'DRAGOON:change:cukur'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then
function by_reply(extra, result, success)   
...
database:sadd(bot_id.."Dev:cukur:2", result.sender_user_id_)
...
database:sadd(bot_id.."Dev:cukur:2", result.id_)
...
database:sadd(bot_id.."Dev:cukur:2", userid)
...
function Function_CUKUR(extra, result, success)
database:srem(bot_id.."Dev:cukur:2", result.sender_user_id_)
...
function Function_CUKUR(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:cukur:2", result.id_)
...
database:srem(bot_id.."Dev:cukur:2", userid)
...
database:del(bot_id.."Dev:cukur:2")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n☆︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'CUKUR_SO')..')'
status  = '\n☆︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n☆︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'CUKUR_SO')..')'
...
if text == 'مسح كليشه المطور' and Devcukur(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,'☆︙ تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and Devcukur(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n☆︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'CUKUR_SO')..')'..'\n☆︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and Devcukur(msg) then  
...
if text == 'تعطيل الاذاعه' and Devcukur(msg) then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'الحفره').."" then  
...
if database:get(bot_id..'Bc:Bots') and not Devcukur(msg) then 
...
database:srem(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
elseif database:sismember(bot_id..'Dev:cukur:2',msg.sender_user_id_) then
database:srem(bot_id..'D9l9l:MN:TF'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Mod:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Special:User'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Manager'..msg.chat_id_, result.sender_user_id_)
...
if text == ("مسح ردود المطور") and Devcukur(msg) then 
...
if text == ("ردود المطور") and Devcukur(msg) then 
local list = database:smembers(bot_id.."List:Rd:Sudo")
text = "\n☆︙قائمة ردود المطور \n — — — — — — — — —\n"
for k,v in pairs(list) do
...
if text == "اضف رد للكل" and Devcukur(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "حذف رد للكل" and Devcukur(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
database:set(bot_id.."CUKUR_SO:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'☆ تم تفعيل الانستا')
database:set(bot_id.."CUKUR_SO:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."CUKUR_SO:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."CUKUR_SO:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☆︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."CUKUR_SO:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."CUKUR_SO:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري  الحفره يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الحفره').." غادر" or text == 'بوت غادر' then  
...
if text == 'تفعيل المغادره' and Devcukur(msg) then   
...
if text == 'تعطيل المغادره' and Devcukur(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'CUKUR_SO')..')'
local iduser = result.sender_user_id_
...
local cukur = '☆︙ عدد الادمنيه : '..data.administrator_count_..
'\n\n☆︙ عدد المطرودين : '..data.kicked_count_..
'\n\n☆︙ عدد الاعضاء : '..data.member_count_..
'\n\n☆︙ عدد رسائل الكروب : '..(msg.id_/2097152/0.5)..
'\n\n☆︙  اسم الكروب : ['..ta.title_..']'
send(msg.chat_id_, msg.id_, cukur) 
end,nil)
end,nil)
end 
...
if not database:sismember(bot_id..'Spam:Texting'..msg.sender_user_id_,text) then
database:sadd(bot_id..'Spam:Texting'..msg.sender_user_id_,text) 
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da)  tdcli_function ({ ID = "SendChatAction",  chat_id_ = msg.sender_user_id_, action_ = {  ID = "SendMessageTypingAction", progress_ = 100}  },function(arg,ta)  tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)  tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = msg.sender_user_id_,offset_ = 0,limit_ = 1},function(extra,cukur,success) 
if da.status_.ID == "ChatMemberStatusCreator" then 
rtpa = 'المالك'
elseif da.status_.ID == "ChatMemberStatusEditor" then 
rtpa = 'مشرف' 
...
local photps = (cukur.total_count_ or 0)
...
local rdphoto = cukura[math.random(#cukura)]
if not database:get(bot_id..'Bot:Id:Photo'..msg.chat_id_) then      
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, cukur.photos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
cukur = text:match("^اضف رسائل (%d+)$")
database:set(bot_id..'id:user'..msg.chat_id_,cukur)  
...
cukur = text:match("^اضف نقاط (%d+)$")
database:set(bot_id..'idgem:user'..msg.chat_id_,cukur)  
...
if text == 'استعاده الاوامر' and Devcukur(msg) then
...
keyboard.inline_keyboard = {
{
{text = 'كتم الاسماء', callback_data="/mute-name"},{text = 'التوحيد', callback_data="/cukur"},{text = 'تنبيه الأسماء', callback_data="/change-names"},
},
{
{text = 'تنبيه المعرف', callback_data="/change-id"},{text = 'تنبيه الصور', callback_data="/change-photo"},
},
{
{text = ' 𝙎??𝙐𝙍𝘾𝞝 ÇUKUR', url="t.me/CUKUR_SO"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
database:set(bot_id.." cukur:zhrf_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الزغرفه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'☆︙ تم تفعيل الزغرفه')
database:set(bot_id.." cukur:zhrf_Bots"..msg.chat_id_,"open")
end
if text and text:match("^زغرفه (.*)$") and database:get(bot_id.." cukur:zhrf_Bots"..msg.chat_id_) == "open" then
...
send(msg.chat_id_, msg.id_, t..'𓍹ⵧⵧⵧⵧⵧⵧ⊱•ÇUKUR•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n☆︙ ➫ .[ ÇUKUR. ](t.me/CUKUR_SO)➤ ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, '☆︙ تم تعطيل الابراج')
database:set(bot_id.." cukur:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,'☆︙ تم تفعيل الابراج')
database:set(bot_id.." cukur:brj_Bots"..msg.chat_id_,"open")
end
if text and text:match("^برج (.*)$") and database:get(bot_id.." cukur:brj_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.." cukur:age_Bots"..msg.chat_id_,"close")
end
if text == "تعطيل حساب العمر" and Manager(msg) then
send(msg.chat_id_, msg.id_, '☆︙ تم تعطيل حساب العمر')
database:set(bot_id.." cukur:age_Bots"..msg.chat_id_,"close")
...
database:set(bot_id.." cukur:age_Bots"..msg.chat_id_,"open")
end
if text and text:match("^احسب (.*)$") and database:get(bot_id.." cukur:age_Bots"..msg.chat_id_) == "open" then
...
database:set(bot_id.."cukur:movie_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الافلام" and Mod(msg) then
send(msg.chat_id_, msg.id_,'☆︙ تم تفعيل الافلام')
database:set(bot_id.."cukur:movie_bot"..msg.chat_id_,"open")
end
if text and text:match("^فلم (.*)$") and database:get(bot_id.."cukur:movie_bot"..msg.chat_id_) == "open" then
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'الحفره')
...
end -- end new msg dev.mr cukur 
end -- end callback dev.mr cukur
