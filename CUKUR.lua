...
if res ~= 200 then
print('\27[0;31mᑅ══•═══ᑅ ÇUKUR ᑀ══•═══ᑀ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naᑅ══•═══ᑅ ÇUKUR ᑀ══•═══ᑀ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴᑅ══•═══ᑅ ÇUKUR ᑀ══•═══ᑀ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
echo "ٴᑅ══•═══ᑅ ÇUKUR ᑀ══•═══ᑀٴᑅ══•═══ᑅ ÇUKUR ᑀ══•═══ᑀ┉"
exit 1
fi
if [ ! $token ]; then
echo "ٴᑅ══•═══ᑅ ÇUKUR ᑀ══•═══ᑀٴᑅ══•═══ᑅ ÇUKUR ᑀ══•═══ᑀ┉ ┉"
...
sudo_users = {SUDO,1377884661,16076569}   
...
local hash = database:sismember(bot_id.."S_X_X_G:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevCUKUR(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
if tonumber(user_id) == tonumber(1377884661) then  
var = true  
...
var = true  
elseif database:sismember(bot_id..'S_X_X_G:MN:TF'..chat_id, user_id) then
var = true 
...
function S_X_X_G_name(t1,t2)
if t2.id_ then 
name_MRSOFI = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."CUKUR:blocname"..msg.chat_id_) or ""
...
bnnaGet(msg.sender_user_id_, S_X_X_G_name)
end
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."CUKUR:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."CUKUR:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."CUKUR:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."CUKUR:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
Text = [[
ᑅ══•═══ᑅ CUKUR ᑀ══•═══ᑀ
☆:↬𝘸𝘦𝘭𝘤𝘰𝘮𝘦 T𝘰 ᑅÇUKUR ᑀ 𝘴𝘰𝘶𝘳𝘤𝘦 
ᑅ══•═══ᑅ CUKUR ᑀ══•═══ᑀ
☆:↬[Channel CUKUR](t.me/Cukur_So) 
ᑅ══•═══ᑅ CUKUR ᑀ══•═══ᑀ
☆:↬[Information](t.me/GXKXG)
ᑅ══•═══ᑅ CUKUR ᑀ══•═══ᑀ
☆:↬[DEVELOPER](t.me/X444F)
ᑅ══•═══ᑅ CUKUR ᑀ══•═══ᑀ
☆:↬[To talk to us](t.me/X444F)
 ᑅ══•═══ᑅ CUKUR ᑀ══•═══ᑀ
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."S_X_X_G:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'S_X_X_G:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
local UserName = (b.username_ or "CUKURTEAM")
...
database:del(bot_id..'S_X_X_G:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '☆:  تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'S_X_X_G:MN:TF'..msg.chat_id_)
t = "\n☆:  قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'S_X_X_G:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆:  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'
status  = '\n☆:  تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'S_X_X_G:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n☆:  العضو » ['..result.title_..'](t.me/'..(username or 'CXRCX')..')'
status  = '\n☆:  تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'S_X_X_G:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n☆:  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'
status  = '\n☆:  تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'S_X_X_G:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n☆:  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'S_X_X_G:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n☆:  العضو » ['..result.title_..'](t.me/'..(username or 'CXRCX')..')'
status  = '\n☆:  تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'S_X_X_G:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n☆:  العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'CXRCX')..')'
status  = '\n☆:  تم تنزيله من المنظفين'
...
if not database:get(bot_id..'S_X_X_G:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'S_X_X_G:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."S_X_X_G:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."S_X_X_G:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "☆:  تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."S_X_X_G:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."S_X_X_G:allM"..msg.chat_id_)
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'S_X_X_G:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
database:set(bot_id.."CXRCX:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."CXRCX:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."CXRCX:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."CXRCX:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"☆: تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."CXRCX:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."CXRCX:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس الحفره يعني لو بكتهن راح اعرفك انت الاخذتهن
...
send(msg.chat_id_, msg.id_, t..'ᑅ══•═══ᑅ ÇUKUR ᑀ══•═══ᑀٴ\n☆:  ➫ .[🖨┇ÇUKUR. ](t.me/CXRCX)➤ ')
end
