...
if hash or SudoBot(msg) or DevCUKURW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevCUKURW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevCUKURW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevCUKURW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCUKURW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCUKURW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevCUKURW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
--------------------------------------------------------------------------------------------------------------
function SourceCUKUR(msg,data) -- بداية العمل عـمـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."CUKUR1:List:Filter"..sl)
...
if not DevCUKURW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevCUKURW(msg) and msg.reply_to_message_id_ ~= 0  then
...
if text == 'تفعيل التواصل ⌯' and DevCUKURW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevCUKURW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevCUKURW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevCUKURW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevCUKURW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevCUKURW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevCUKURW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevCUKURW(msg) then 
...
if text == 'الاصدار ⌯' and DevCUKURW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس الحفره* \n*⌯︙الاصدار -›{ 2.8v}*')
end
if text == "ضع اسم للبوت ⌯" and DevCUKURW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevCUKURW(msg) then 
...
if text == 'المشتركين ⌯' and DevCUKURW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين-› {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevCUKURW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات-› {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevCUKURW(msg) then
...
if text == ("قائمه العام ⌯") and DevCUKURW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevCUKURW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevCUKURW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevCUKURW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevCUKURW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevCUKURW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevCUKURW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevCUKURW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevCUKURW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌯" and DevCUKURW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع مطور @(.*)$") and DevCUKURW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevCUKURW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevCUKURW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevCUKURW(msg) then
...
if CUKUR1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙اسم المستخدم -›* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Cukur_So')..') \n ⌯︙'..CUKUR1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevCUKURW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevCUKURW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevCUKURW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevCUKURW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevCUKURW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevCUKURW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevCUKURW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevCUKURW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevCUKURW(msg) then  
...
if t2.id_ then 
name_CUKUR = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_CUKUR then 
names_CUKUR = database:smembers(bot_id.."CUKUR:blocname"..msg.chat_id_) or ""
if names_CUKUR and names_CUKUR[1] then 
for i=1,#names_CUKUR do 
if name_CUKUR:match("(.*)("..names_CUKUR[i]..")(.*)") then 
...
function amir_CUKURa_new(CUKUR1,CUKUR2)
if CUKUR2 and CUKUR2.first_name_ then 
if CUKUR2.first_name_:match("(.*)"..database:get(bot_id.."CUKUR:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."CUKUR:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local CUKUR_nnn = database:get(bot_id.."CUKUR:nump"..msg.chat_id_) or 5
local CUKUR_nnn2 = database:get(bot_id.."CUKUR:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(CUKUR_nnn2) == tonumber(CUKUR_nnn) or tonumber(CUKUR_nnn2) > tonumber(CUKUR_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."CUKUR:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي ~⪼["..CUKUR2.username_.."](https://t.me/"..(CUKUR2.username_ or "Cukur_So")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."CUKUR:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(CUKUR_nnn) - tonumber(CUKUR_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_CUKURa_new)
end
end
...
Text = [[
*أهلاً بك في السوࢪس* [CuKuR TeAm]
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السوࢪس',url="https://t.me/Cukur_So"},
},
{
{text = 'مطوࢪ السوࢪس',url="t.me/X444F"},
},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'رفع نسخه الاحتياطيه' and DevCUKURW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل التكرار العام' and DevCUKURW(msg) then 
database:del(bot_id..'antk'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,' *⌯︙تم تفعيل التكرار العام*') 
return false  
end
if text == 'تعطيل التكرار العام' and DevCUKURW(msg) then 
...
if text == "حذف اللقب" and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
function reply(extra, result, success)
database:del(bot_id..'TextCll'..msg.chat_id_..':'..result.sender_user_id_)  
send(msg.chat_id_, msg.id_, "\n *⌯︙تم حذف لقبه بنجاح*")  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
end
if text and text:match("^اضف لقب (.*)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
local TextCll = text:match("^اضف لقب (.*)$")
function reply(extra, result, success)
database:set(bot_id..'TextCll'..msg.chat_id_..':'..result.sender_user_id_,TextCll)  
send(msg.chat_id_, msg.id_, "\n *⌯︙تم اضافة له {"..TextCll..'} ك لقب*')  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
end
...
function reply(extra, result, success)
local TextCll = database:get(bot_id..'TextCll'..msg.chat_id_..':'..result.sender_user_id_)
if not TextCll then 
Text = ' *⌯︙لم يتم اضافه لقب له*'
else
Text = '*⌯︙لقبه هو :*'..TextCll
end
send(msg.chat_id_, msg.id_,Text)  
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
...
if text == 'لقبي' then 
local Cll = database:get(bot_id..'TextCll'..msg.chat_id_..':'..msg.sender_user_id_)
if not Cll then 
Text = ' *⌯︙لم يتم اضافه لقب لك*'
else
Text = '*⌯︙لقبك هو :*'..Cll
end
send(msg.chat_id_, msg.id_,Text) 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه -›* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Cukur_So')..') \n*⌯︙تـم قفـل الدردشه* ')
end,nil)   
...
elseif text == 'قفل البوتات' and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
database:set(bot_id.."lock:Bot:kick"..msg.chat_id_,'del')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه -›* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Cukur_So')..') \n*⌯︙تـم قفـل البوتات* ')
end,nil)   
elseif text == 'قفل البوتات بالطرد' and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
...
elseif text == 'قفل التعديل' and msg.reply_to_message_id_ == 0 and DevCUKURW(msg) then 
...
elseif text == 'قفل تعديل الميديا' and msg.reply_to_message_id_ == 0 and DevCUKURW(msg) then 
...
elseif text == 'فتح البوتات' and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
database:del(bot_id.."lock:Bot:kick"..msg.chat_id_)  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه -›* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Cukur_So')..') \n*⌯︙تـم فـتح البوتات* ')
end,nil)   
elseif text == 'فتح البوتات بالطرد' and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
database:del(bot_id.."lock:Bot:kick"..msg.chat_id_)  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
elseif text == 'فتح التعديل' and msg.reply_to_message_id_ == 0 and DevCUKURW(msg) then 
...
elseif text == 'فتح تعديل الميديا' and msg.reply_to_message_id_ == 0 and DevCUKURW(msg) then 
...
------------------------------------------------------------------------ عـمـر الـدلـيـم
if text == 'تحديث' and DevCUKURW(msg) then
dofile('CUKUR.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevCUKURW(msg) then
...
------------------------------------------------------------------------ عـمـر الـدلـيـم
if text == ("مسح المطورين") and DevCUKURW(msg) then
...
if text == 'الملفات' and DevCUKURW(msg) then
...
if DevCUKURW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/CUKURTEAM/File_Bot/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevCUKURW(msg) then
...
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورس الحفره* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevCUKURW(msg) then
...
if text == "مسح الملفات" and DevCUKURW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevCUKURW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevCUKURW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "Cukur_So")
...
if text and text:match("^رفع ثانوي @(.*)$") and SudoBot(msg) then
local username = text:match("^رفع ثانوي @(.*)$")
function Function_CUKUR(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"*⌯︙عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !*")   
...
if text == ("حذف ثانوي") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_CUKUR(extra, result, success)
...
if text and text:match("^حذف ثانوي @(.*)$") and SudoBot(msg) then
local username = text:match("^حذف ثانوي @(.*)$")
function Function_CUKUR(extra, result, success)
if result.id_ then
...
if text and text:match("^حذف ثانوي (%d+)$") and SudoBot(msg) then
local userid = text:match("^حذف ثانوي (%d+)$")
...
------------------------------------------------------------------------ عـمـر الـدلـيـم
------------------------------------------------------------------------ عـمـر الـدلـيـم
if text == 'مسح المميزين' and Sudo(msg) then
...
if text and text == "منع" and msg.reply_to_message_id_ == 0 and DevCUKURW(msg)  then   
...
if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and DevCUKURW(msg) then
...
if text == 'منع' and tonumber(msg.reply_to_message_id_) > 0 and DevCUKURW(msg) then     
function cb(a,b,c) 
textt = ' *⌯︙تم منع* '
...
if text == 'الغاء منع' and tonumber(msg.reply_to_message_id_) > 0 and DevCUKURW(msg) then     
function cb(a,b,c) 
textt = ' *⌯︙تم الغاء منع* '
...
if text == "مسح قائمه المنع"and DevCUKURW(msg) then   
...
if text == "قائمه المنع" and DevCUKURW(msg) then   
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙اسم المستخدم -›* ['..result.title_..'](t.me/'..(text1[3] or 'Cukur_So')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevCUKURW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevCUKURW(msg) then  
...
if database:get(bot_id..'Bc:Bots') and not DevCUKURW(msg) then 
...
if CUKURSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevCUKURW(msg) then 
...
if text == ("ردود المطور") and DevCUKURW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*•━━━━━━ cKr ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevCUKURW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevCUKURW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'الحفره').." غادر" or text == 'غادر' then  
if Sudo(msg) and not database:get(bot_id..'Left:Bot'..msg.chat_id_)  then 
tdcli_function ({ID = "ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
send(msg.chat_id_, msg.id_,'*⌯︙تم مغادرة المجموعه*') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
...
if text == 'تفعيل المغادره' and DevCUKURW(msg) then   
...
if text == 'تعطيل المغادره' and DevCUKURW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙اسم المستخدم -› ['..data.first_name_..'](t.me/'..(data.username_ or 'CUKUR')..') '
...
if text == 'استعاده الاوامر' and DevCUKURW(msg) then
...
{{text = 'CuKuR TeAm', url="t.me/CUKURTEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*•━━━━━━ cKr ━━━━━━━•*ٴ⌯∫○ٴ\n⌯︙[CuKuR TeAm](t.me/Cukur_So) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'CuKuR TeAm.',url="t.me/Cukur_So"}},
}
local msg_id = msg.id_/2097152/0.5
...
inline = {
{{text = 'CuKuR TeAm',url='http://t.me/Cukur_So'}},
}
